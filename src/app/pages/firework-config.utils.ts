// firework-config.utils.ts

export function getFireworkConfig1() {
  return {
    autoPlay: true,
    background: {
      color: { value: "#000" },
    ...
    particles: {
      ...
      move: {
        ...
        outModes: { default: "destroy", bottom: "destroy", left: "destroy", right: "destroy", top: "none" },
        random: false,
        size: false,
        speed: { min: 10, max: 20 },
        spin: { acceleration: 0, enable: false },
        straight: false,
        trail: { enable: true, length: 10, fill: { color: { value: "#000" } } },
        vibrate: false,
        warp: false
      },
      number: {
      ...
      shape: { close: true, fill: true, options: {}, type: "line" },
      size: {
        ...
        split: {
          ...
          particles: {
            ...
            move: {
              decay: 0.05,
              enable: true,
              gravity: { enable: true, inverse: false, acceleration: 5 },
              speed: { min: 5, max: 10 },
              direction: "none",
              outModes: "destroy"
            }
    ...
    emitters: {
      autoPlay: true,
      fill: true,
      life: { wait: false, count: 0, delay: 0.1, duration: 0.1 },
      rate: { quantity: 1, delay: 0.15 },
...
export function getFireworkConfig2() {
  // קונפיגורציה שונה לדוגמה
  return {
    name: "Fireworks Simple",
